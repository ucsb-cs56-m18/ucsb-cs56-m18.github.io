...
<li markdown="1" style="margin-bottom:6em;"> (5 pts) Please refer to the `Student` class on [handout B](handout_b/) and the `Main` class on [handout A](handout_a/).  You
...
<li markdown="1" style="margin-bottom:6em;"> (5 pts) Please refer to the `Student` class on [handout B](handout_b/) and the `Main` class on [handout A](handout_a/).  You see that the output for each student is formatted in a particular way when the `toString` of `Student` is implicitly invoked
...
<li markdown="1" style="margin-bottom:6em;"> (5 pts) Please refer to the `Student` class on [handout B](handout_b/).  You see that this class implements `Comparable<Student>`, but the `compareTo` method has a blank in it.
